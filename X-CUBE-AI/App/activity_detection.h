...
#ifndef AI_ACTIVITY_DETECTION_H
#define AI_ACTIVITY_DETECTION_H
#pragma once

#include "activity_detection_config.h"
#include "ai_platform.h"

/******************************************************************************/
#define AI_ACTIVITY_DETECTION_MODEL_NAME          "activity_detection"
#define AI_ACTIVITY_DETECTION_ORIGIN_MODEL_NAME   "activity_model"

/******************************************************************************/
#define AI_ACTIVITY_DETECTION_ACTIVATIONS_ALIGNMENT   (4)
#define AI_ACTIVITY_DETECTION_INPUTS_IN_ACTIVATIONS   (4)
#define AI_ACTIVITY_DETECTION_OUTPUTS_IN_ACTIVATIONS  (4)

/******************************************************************************/
#define AI_ACTIVITY_DETECTION_IN_NUM        (1)

AI_DEPRECATED
#define AI_ACTIVITY_DETECTION_IN \
  ai_activity_detection_inputs_get(AI_HANDLE_NULL, NULL)

#define AI_ACTIVITY_DETECTION_IN_SIZE { \
  AI_ACTIVITY_DETECTION_IN_1_SIZE, \
}
#define AI_ACTIVITY_DETECTION_IN_SIZE_BYTES { \
  AI_ACTIVITY_DETECTION_IN_1_SIZE_BYTES, \
}
#define AI_ACTIVITY_DETECTION_IN_1_HEIGHT      (26)
#define AI_ACTIVITY_DETECTION_IN_1_CHANNEL     (3)
#define AI_ACTIVITY_DETECTION_IN_1_SIZE        (26 * 3)
#define AI_ACTIVITY_DETECTION_IN_1_SIZE_BYTES  (312)

/******************************************************************************/
#define AI_ACTIVITY_DETECTION_OUT_NUM       (1)

AI_DEPRECATED
#define AI_ACTIVITY_DETECTION_OUT \
  ai_activity_detection_outputs_get(AI_HANDLE_NULL, NULL)

#define AI_ACTIVITY_DETECTION_OUT_SIZE { \
  AI_ACTIVITY_DETECTION_OUT_1_SIZE, \
}
#define AI_ACTIVITY_DETECTION_OUT_SIZE_BYTES { \
  AI_ACTIVITY_DETECTION_OUT_1_SIZE_BYTES, \
}
#define AI_ACTIVITY_DETECTION_OUT_1_CHANNEL     (3)
#define AI_ACTIVITY_DETECTION_OUT_1_SIZE        (3)
#define AI_ACTIVITY_DETECTION_OUT_1_SIZE_BYTES  (12)

/******************************************************************************/
#define AI_ACTIVITY_DETECTION_N_NODES (6)


AI_API_DECLARE_BEGIN

/*!
 * @defgroup activity_detection
 ...
 * @ref ai_activity_detection_create. Both the activations memory buffer 
 ...
 * using @ref ai_activity_detection_get_error
 */
AI_API_ENTRY
 ...
 */
AI_API_ENTRY
ai_buffer* ai_activity_detection_inputs_get(
 ...
 */
AI_API_ENTRY
ai_buffer* ai_activity_detection_outputs_get(
  ai_handle network, ai_u16 *n_buffer);
 ...
 * header generated by the code generation tool. See AI_ACTIVITY_DETECTION_*
 * defines into file @ref activity_detection.h for all network sizes defines
 *
 * @param network an opaque handle to the network context
 ...
 */
AI_API_ENTRY
ai_i32 ai_activity_detection_forward(
  ai_handle network, const ai_buffer* input);

AI_API_DECLARE_END

#endif /* AI_ACTIVITY_DETECTION_H */
